...
export function MonthDetailModal({
  ...
  return (
    <div
      className="modal-backdrop month-detail-backdrop"
      onClick={closeModal}
    >
      <section
        ref={modalRef}
        className="modal month-detail-modal native-month-modal"
        ...
        <div className="month-detail-layout">
          ...
          <section className="month-event-list">
            ...
            {monthEvents.length === 0 && (
              <p className="muted">
                No hay eventos cargados en este mes.
              </p>
            )}
